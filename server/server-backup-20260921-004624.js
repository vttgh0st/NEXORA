...
async function handleWebhook(req, res) {
    ...
    try {
        ...
        /*
         * Sem Access Token não podemos consultar
         * o pagamento diretamente no Mercado Pago.
         */
        ...
        /*
         * Atualizamos o pedido somente depois
         * de consultar o pagamento diretamente.
         */
        ...
        if (
             ...
             * IMPORTANTE:
             *
             * Ainda não liberamos o ZIP aqui.
             * O próximo passo vai criar um mecanismo
             * seguro de download.
             */

            orders[index].downloadUnlocked =
                false;
